                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="<?php echo $imge ?> " alt=""/></div>
                            <div></div>
                        </div>
                    </div>

                    <div class="col-md-7 animate-box">
                        <a href="single.php ?id=<?php echo $id ?>" class="fh5co_magna py-2"> <?php echo  $name_post ?>
                         </a> <a href="#" class="fh5co_mini_time py-3"><?php echo   $date ?>  </a>
                        <div class="fh5co_consectetur"> <?php echo   $description ?>
                        </div>
                    </div>
                </div>
                <?php }?>
    ...
    <div class="container animate-box">
        ...
        <div class="owl-carousel owl-theme" id="slider2">
                <?php       
                   ...
                   $sql2 = "select * from post ORDER BY RAND()";
                   $res2 = mysqli_query($coon , $sql2);
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="<?php echo $imge2 ?>" alt=""/></div>
                    <div>
                        <a href="single.php ?id=<?php echo $id2?>" class="d-block fh5co_small_post_heading"><span class=""><?php echo $name_post2 ?></span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i><?php echo $date2 ?></div>
                    </div>
                </div>
            </div>
             <?php } ?>
