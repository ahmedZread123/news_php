...
<div class="container-fluid paddding mb-5">
    <div class="row mx-0">
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="<?php echo $imge1;?>" alt="img"/>
                <div class="fh5co_suceefh5co_height_position_absolute"></div>
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?php echo $date1;?>
                    </a></div>
                    <div class=""><a href="single.php ?id=<?php echo $id1 ?> " class="fh5co_good_font"> <?php echo $name_post1;?></a></div>
                </div>
            </div>
        </div>
         ...
         <div class="col-md-6">
            ...
            ?>
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="<?php echo $imge;?>" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?php echo $date;?>
                          </a></div>
                            <div class=""><a href="single.php ?id=<?php echo $id ?>" class="fh5co_good_font_2"> <?php echo $name_post;?></a></div>
                        </div>
                    </div>
                </div>
                <?php 
...
<div class="container-fluid pt-3">
    <div class="container animate-box" data-animate-effect="fadeIn">
        ...
        <?php       
          $sqll = "select * from post ORDER BY RAND()  ";
          $ress = mysqli_query($coon , $sqll);
          while($row2 =$ress->fetch_assoc() ){
            $id2 = $row2['id'];
            $name_post2 = $row2['name_post'];
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img src="<?php echo  $imge2;?>" alt=""
                                                           class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="single.php ?id=<?php echo $id2 ?>" class="text-white"><?php echo $name_post2 ?> </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> <?php echo $name_post2?>  - <?php echo $date2?> </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        ...
        <?php       
          ...
          $res3 = mysqli_query($coon , $sql3);
          while($row3 =$res3->fetch_assoc() ){
            $id3 = $row3['id'];
            $name_post3 = $row3['name_post'];
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="<?php echo $imge3 ?>" alt=""/></div>
                    <div>
                        <a href="single.php ?id=<?php echo $id3 ?>" class="d-block fh5co_small_post_heading"><span class=""><?php echo $name_post3 ?></span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i><?php echo $date3 ?></div>
                    </div>
                </div>
            </div>
            <?php }?>
        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    ...
                    <?php       
                    // عكس البيانات 
          $sql4 = "select   * from post order by id desc limit  4";
          ...
          while($row4 =$res4->fetch_assoc() ){
            ...
            ?>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="<?php echo $imge4 ?>" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="single.php ?id=<?php echo $id4 ?>" class="fh5co_magna py-2"> <?php echo  $name_post4 ?>
                         </a> <a href="single.php ?id=<?php echo $id4 ?>" class="fh5co_mini_time py-3"> 
                        <?php echo $date4 ?> </a>
                        <div class="fh5co_consectetur"> <?php echo $description4 ?>
                        </div>
                    </div>
                </div>
         <?php }?>
            ...
            ?>
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="<?php echo $imge5 ?>" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"><?php echo $name_post5 ?> </div>
                        <div class="most_fh5co_treding_font_123"> <?php echo $date5 ?></div>
                    </div>
                </div>
            <?php }?>
                <!-- <div class="row pb-3">
